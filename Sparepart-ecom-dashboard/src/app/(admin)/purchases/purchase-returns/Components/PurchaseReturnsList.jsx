...
const PurchaseReturnsList = async () => {
  const purchaseReturnsData = await getAllOrders()
      ...
      <Col xl={12}>
        <Card>
          <div className="d-flex card-header justify-content-between align-items-center">
            <div>
              <CardTitle as={'h4'}>All Return Items</CardTitle>
            </div>
            <div className="d-flex gap-2">
              <Dropdown>
                ...
                <DropdownMenu className="dropdown-menu-end">
                  ...
                  <DropdownItem href="/purchases/purchase-order" className="dropdown-item">
                    <IconifyIcon icon="solar:cart-plus-bold-duotone" className="me-2" />
                    Purchase Order
                  </DropdownItem>
                </DropdownMenu>
              </Dropdown>
          ...
          <CardBody className="p-0">
            <div className="table-responsive">
              <table className="table align-middle mb-0 table-hover table-centered">
                ...
                <tbody>
                  {purchaseReturnsData.map((item, idx) => (
                    <tr key={idx}>
                      <td>
                        <div className="form-check">
                      ...
                      <td>
                        {' '}
                        <span className="badge bg-warning text-dark py-1 px-2">Pending Review</span>{' '}
                      </td>
                      <td>
