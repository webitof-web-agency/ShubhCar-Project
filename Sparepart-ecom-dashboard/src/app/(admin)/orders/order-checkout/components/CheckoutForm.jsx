                  ...
                  <Col lg={4}>
                    <form>
                      <div className="mb-3">
                        ...
                        <input type="number" id="your-zipcode" className="form-control" placeholder="PIN code" />
                      </div>
                    </form>
                  </Col>
                  <Col lg={4}>
              ...
              <div className="d-flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-white-50 mb-0">
                    Below your selected items, enter your PIN code to calculate the shipping charge. We like to make shipping simple and affordable!
                  </p>
                </div>
              </div>
